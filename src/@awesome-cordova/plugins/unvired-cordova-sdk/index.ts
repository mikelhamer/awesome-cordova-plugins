...
import { Plugin, Cordova, IonicNativePlugin } from '@awesome-cordova/core';
 ...
 * @usage
 * ```typescript
 * import { UnviredCordovaSDK } from '@awesome-cordova/unvired-cordova-sdk/ngx';
 *
 *
...
@Plugin({
  ...
  install: 'ionic cordova plugin add @awesome-cordova/unvired-cordova-sdk', // OPTIONAL install command, in case the plugin requires variables
