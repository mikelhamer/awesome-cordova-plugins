...
import { CordovaCheck, CordovaInstance, getPromise, IonicNativePlugin, Plugin } from '@awesome-cordova/core';
 ...
 *
 * ```typescript
 * import { SecureStorageEcho, SecureStorageEchoObject } from '@awesome-cordova/secure-storage-echo/ngx';
 *
