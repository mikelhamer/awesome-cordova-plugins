...
import { CordovaInstance, InstanceProperty, IonicNativePlugin, Plugin, checkAvailability } from '@awesome-cordova/core';
 ...
 * @usage
 * ```typescript
 * import { Media, MediaObject } from '@awesome-cordova/media/ngx';
 *
 *
 ...
 * ```typescript
 * import { Media, MediaObject } from '@awesome-cordova/media/ngx';
 * import { File } from '@awesome-cordova/file/ngx';
 *
 * ...
 *
