...
import { Cordova, CordovaProperty, IonicNativePlugin, Plugin } from '@awesome-cordova/core';
 ...
 * @usage
 * ```typescript
 * import { MediaCapture, MediaFile, CaptureError, CaptureImageOptions } from '@awesome-cordova/media-capture/ngx';
 *
 *
