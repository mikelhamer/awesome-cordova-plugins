...
import { Cordova, CordovaFunctionOverride, IonicNativePlugin, Plugin } from '@awesome-cordova/core';
 ...
 * ```typescript
 * import { ThreeDeeTouch, ThreeDeeTouchQuickAction, ThreeDeeTouchForceTouch } from '@awesome-cordova/three-dee-touch/ngx';
 *
