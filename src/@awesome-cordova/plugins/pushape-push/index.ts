...
import { Plugin, Cordova, CordovaInstance, IonicNativePlugin, checkAvailability } from '@awesome-cordova/core';
 ...
 * @usage
 * ```typescript
 * import { PushapePush } from '@awesome-cordova/pushape-push/ngx';
 *
 *
