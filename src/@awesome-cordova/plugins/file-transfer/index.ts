...
import { CordovaInstance, InstanceCheck, IonicNativePlugin, Plugin, checkAvailability } from '@awesome-cordova/core';
 ...
 * @usage
 * ```typescript
 * import { FileTransfer, FileUploadOptions, FileTransferObject } from '@awesome-cordova/file-transfer/ngx';
 * import { File } from '@awesome-cordova/file';
 *
