 ...
 * @usage
 * ```typescript
 * import { OpenALPR, OpenALPROptions, OpenALPRResult } from '@awesome-cordova/openalpr/ngx';
 *
 *
 ...
 * }
 *
 * // To get imageData, you can use the @awesome-cordova/camera module for example. It works with DestinationType.FILE_URI and DATA_URL
 *
