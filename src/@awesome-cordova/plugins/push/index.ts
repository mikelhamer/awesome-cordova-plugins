...
import { Cordova, CordovaInstance, IonicNativePlugin, Plugin, checkAvailability } from '@awesome-cordova/core';
 ...
 * @usage
 * ```typescript
 * import { Push, PushObject, PushOptions } from '@awesome-cordova/push/ngx';
 *
