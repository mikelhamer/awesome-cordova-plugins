...
import { CordovaCheck, CordovaInstance, IonicNativePlugin, Plugin, getPromise } from '@awesome-cordova/core';
 ...
 *
 * ```typescript
 * import { SecureStorage, SecureStorageObject } from '@awesome-cordova/secure-storage/ngx';
 *
