...
const webpackConfig: webpack.Configuration = {
  ...
  resolve: {
    ...
    extensions: ['.js'],
    alias: {
      '@awesome-cordova/core': path.resolve(DIST, '@awesome-cordova/core/index.js'),
    },
  },
  module: {
    rules: [
...
function createIndexFile() {
  ...
  fileContent += '\n};\n';
  fileContent += `require('./@awesome-cordova/core/bootstrap').checkReady();\n`;
  fileContent += `require('./@awesome-cordova/core/ng1').initAngular1(window.IonicNative);`;
